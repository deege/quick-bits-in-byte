 ...
 * 
 * @see <a href="https://www.youtube.com/watch?v=Hzuzo9NJrlc">4 ways to count bits in a byte</a>
 * 
 */
public class App {
    ...
    public static void main( String[] args ) {
        ...
        for (int i=0; i<256; i++) {
            byte b = (byte) (i - 128);
            System.out.println("Bits in " + "b = " + countBits1(b) + " " + countBits2(b) + " " + countBits3(b) + " " + countBits4(b));
        }
    }
    ...
    public static int countBits4(final byte test) {
        return App.setBitCounts[test + 128];
    }
